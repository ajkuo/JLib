# coding: utf-8
from JLib import JConfig as config, JTime
    ...
    def Write(source=None, actionType=None, actionContent=None, target=None, noteText=None, noteNum1=None, noteNum2=None, createTime=None):
        ...
        if source is None:
            ...
            if createTime is None:
                createTime = JTime.GetNowDatetime()
        ...
        if file_result and db_result:
            jsonResult = Rsp.Dumps(message, result=True, time=createTime)
        else:
            jsonResult = Rsp.Dumps(message, result=False, error=True)
